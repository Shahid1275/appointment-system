...
// import DoctorDashboard from "./pages/doctor/DoctorDashboard"; // Correct import path
...
//     }
//     // Redirect to appropriate dashboard based on token
...
//           <div className="flex items-start">
//             <SideBar />{" "}
//             {/* Modify SideBar for doctor-specific links if needed */}
//             <Routes>
